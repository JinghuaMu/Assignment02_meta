...
Meanwhile, we perform a meta-analysis of inverse VRR versus lnRR. To filter too large values, we choose to refer to table \@ref(tab:table4) to take the 95% quantile.
```{r}
